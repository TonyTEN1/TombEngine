...
namespace TEN::Gui
{
	...
	InventoryObject InventoryObjectTable[INVENTORY_TABLE_SIZE] =
	{
		...
		{ ID_FLARE_INV_ITEM, 6, 0.4f, EulerAngles::Zero, OPT_USE, STRING_FLARES, NO_JOINT_BITS, INV_ROT_Y },
		{ ID_TIMEX_ITEM, 2, 0.4f, EulerAngles::Zero, OPT_STATS, STRING_STATISTICS, NO_JOINT_BITS, INV_ROT_Y },
		{ ID_PC_LOAD_INV_ITEM, -24, 0.15f, EulerAngles(0, ANGLE(180.0f), 0), OPT_LOAD, STRING_LOAD_GAME, NO_JOINT_BITS, INV_ROT_Y },
		{ ID_PC_SAVE_INV_ITEM, -24, 0.15f, EulerAngles(0, ANGLE(180.0f), 0), OPT_SAVE, STRING_SAVE_GAME, NO_JOINT_BITS, INV_ROT_Y },
